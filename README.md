### This Repo contain slightly modified sd-scripts used for pretraining Animagine XL 3.0, however it's recommended to use latest version because the biggest issue for multi gpu training has been fixed in the main repository.
